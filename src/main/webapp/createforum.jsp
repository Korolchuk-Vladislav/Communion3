...
<head>
    ...
    <title>Communion | Создание форума</title>
...
<div
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">Создание форума</div>
        <div class="panel-body">
            <form class="form-horizontal" action='addforum' method="POST"
                  id="mForm">
                <fieldset>
                    ...
                    <div class="control-group">
                        <label class="control-label" for="image">Изображение(URL)</label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <!-- city -->
                        <label class="control-label" for="about">Описание</label>
                        <div class="controls">
                            <input type="text" id="about" name="about" placeholder=""
                                   class="form-control">
                        </div>
                    </div>
                    <input type="hidden" value="0" name="isPublic" id="isPublic">
                    <div class="control-group">
                        <!-- continue -->
                        <div class="controls">
